...
async def classify_intent(
    ...
    system_prompt = (
        ...
        "NO es una peticion de humano: el bot debe interpretar y preguntar para confirmar, no se "
        "debe transferir por incertidumbre. Solo marcar true ante una peticion EXPLICITA de persona/agente. "
